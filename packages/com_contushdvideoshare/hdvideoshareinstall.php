...
PRIMARY KEY (`id`)
	...
	{
		$groupname = '25';
		$column_upload = array( 'id', 'memberid', 'published', 'title', 'seotitle', 'featured',
		...
		$query->clear() ->insert($db->quoteName('#__hdflv_upload')) ->columns($column_upload)
				->values(
						implode(
								',',
								array(
...
$installer->install($this->parent->getPath('source') . '/extensions/mod_videoplusbanner');
$installer->install($this->parent->getPath('source') . '/extensions/mod_videopluscategories');
$installer->install($this->parent->getPath('source') . '/extensions/mod_videoplusheader');
...
if (version_compare(JVERSION, '2.5.0', 'ge')
	...
	JFile::move($rootPath . DS . 'plugins' . DS . 'content' . DS . 'hvsarticle' . DS . 'hvsarticle.j3.xml',
        ...
        if (JFile::exists($rootPath . '/modules/mod_videoplusbanner/mod_videoplusbanner.xml')) {
	  JFile::delete($rootPath . '/modules/mod_videoplusbanner/mod_videoplusbanner.xml');
	}
	JFile::move( $rootPath . '/modules/mod_videoplusbanner/mod_videoplusbanner.j3.xml',
	$rootPath . '/modules/mod_videoplusbanner/mod_videoplusbanner.xml');
	
	if (JFile::exists($rootPath . '/modules/mod_videopluscategories/mod_videopluscategories.xml')) {
	  JFile::delete($rootPath . '/modules/mod_videopluscategories/mod_videopluscategories.xml');
	}	
	JFile::move( $rootPath . '/modules/mod_videopluscategories/mod_videopluscategories.j3.xml',
	$rootPath . '/modules/mod_videopluscategories/mod_videopluscategories.xml');
	
	if (JFile::exists($rootPath . '/modules/mod_videoplusheader/mod_videoplusheader.xml')) {
	  JFile::delete($rootPath . '/modules/mod_videoplusheader/mod_videoplusheader.xml');
	}	
	JFile::move( $rootPath . '/modules/mod_videoplusheader/mod_videoplusheader.j3.xml',
	$rootPath . '/modules/mod_videoplusheader/mod_videoplusheader.xml');
}
...
/** Query to update categories module position into db */
$query->clear() ->update($db->quoteName('#__modules')) ->set($db->quoteName('published') . ' = ' . $db->quote('1')) ->set($db->quoteName('position') . ' = ' . $db->quote($positionRight))
...
$db->query();
$mid1 = $db->loadResult();
$db->setQuery("INSERT IGNORE INTO #__modules_menu (moduleid) VALUES ('$mid1')");
$db->query();

/** Query to update videoshare modules module position into db */
$query->clear() ->update($db->quoteName('#__modules')) ->set($db->quoteName('published') . ' = ' . $db->quote('1')) ->set($db->quoteName('position') . ' = ' . $db->quote($positionRight))
...
$db->query();
$mid2 = $db->loadResult();
$db->setQuery("INSERT IGNORE INTO #__modules_menu (moduleid) VALUES ('$mid2')");
$db->query();

/** Query to update search videos module position into db */
$query->clear() ->update($db->quoteName('#__modules')) ->set($db->quoteName('published') . ' = ' . $db->quote('1')) ->set($db->quoteName('position') . ' = ' . $db->quote($positionRight))
...
$db->query();
$mid3 = $db->loadResult();
$db->setQuery("INSERT IGNORE INTO #__modules_menu (moduleid) VALUES ('$mid3')");
$db->query();

/** Query to update videoshare player module position into db */
$query->clear() ->update($db->quoteName('#__modules')) ->set($db->quoteName('published') . ' = ' . $db->quote('0')) ->set($db->quoteName('position') . ' = ""')
->where($db->quoteName('module') . ' = ' . $db->quote('mod_videoshare'));
$db->setQuery($query);
$db->query();

$query->clear() ->select('id') ->from($db->quoteName('#__modules')) ->where($db->quoteName('module') . ' = ' . $db->quote('mod_videoshare'));
$db->setQuery($query);
$db->query();
$mid4 = $db->loadResult();
$db->setQuery("INSERT IGNORE INTO #__modules_menu (moduleid) VALUES ('$mid4')");
$db->query();
...
$db->query();
$mid5 = $db->loadResult();
$db->setQuery("INSERT IGNORE INTO #__modules_menu (moduleid) VALUES ('$mid5')");
$db->query();

/** Query to update videoplus banner module position into db */
$query->clear() ->update($db->quoteName('#__modules')) ->set($db->quoteName('published') . ' = ' . $db->quote('1')) ->set($db->quoteName('position') . ' = ' . $db->quote('videoplus-banner'))
->where($db->quoteName('module') . ' = ' . $db->quote('mod_videoplusbanner'));
$db->setQuery($query);
$db->query();

$query->clear() ->select('id') ->from($db->quoteName('#__modules')) ->where($db->quoteName('module') . ' = ' . $db->quote('mod_videoplusbanner'));
$db->setQuery($query);
$db->query();
$mid6 = $db->loadResult();
$db->setQuery("INSERT IGNORE INTO #__modules_menu (moduleid) VALUES ('$mid6')");
$db->query();

/** Query to update videoplus categories module position into db */
$query->clear() ->update($db->quoteName('#__modules')) ->set($db->quoteName('published') . ' = ' . $db->quote('1')) ->set($db->quoteName('position') . ' = ' . $db->quote('videoplus-category'))
->where($db->quoteName('module') . ' = ' . $db->quote('mod_videopluscategories'));
$db->setQuery($query);
$db->query();

$query->clear() ->select('id') ->from($db->quoteName('#__modules')) ->where($db->quoteName('module') . ' = ' . $db->quote('mod_videopluscategories'));
$db->setQuery($query);
$db->query();
$mid7 = $db->loadResult();
$db->setQuery("INSERT IGNORE INTO #__modules_menu (moduleid) VALUES ('$mid7')");
$db->query();

/** Query to update videoplus header module position into db */
$query->clear() ->update($db->quoteName('#__modules')) ->set($db->quoteName('published') . ' = ' . $db->quote('1')) ->set($db->quoteName('position') . ' = ' . $db->quote('videoplus-header'))
->where($db->quoteName('module') . ' = ' . $db->quote('mod_videoplusheader'));
$db->setQuery($query);
$db->query();

$query->clear() ->select('id') ->from($db->quoteName('#__modules')) ->where($db->quoteName('module') . ' = ' . $db->quote('mod_videoplusheader'));
$db->setQuery($query);
$db->query();
$mid8 = $db->loadResult();
$db->setQuery("INSERT IGNORE INTO #__modules_menu (moduleid) VALUES ('$mid8')");
$db->query();
?>
...
?>
		...
		<tr class="row0">
			<td class="key" colspan="2"><?php echo 'VideoPlus Header - ' . JText::_('Module'); ?></td>
			<td style="text-align: center;">
<?php
if (version_compare(JVERSION, '1.6.0', 'ge')) {
	$query->clear() ->select('extension_id') ->from($db->quoteName('#__extensions')) ->where($db->quoteName('type') . ' = ' . $db->quote('module'))
...
?>
		...
		<tr class="row0">
			<td class="key" colspan="2"><?php echo 'VideoPlus Banner - ' . JText::_('Module'); ?></td>
			<td style="text-align: center;">
<?php
if (version_compare(JVERSION, '1.6.0', 'ge')) {
	$query->clear() ->select('extension_id') ->from($db->quoteName('#__extensions')) ->where($db->quoteName('type') . ' = ' . $db->quote('module'))
...
?>
		...
		<tr class="row0">
			<td class="key" colspan="2"><?php echo 'VideoPlus Categories - ' . JText::_('Module'); ?></td>
			<td style="text-align: center;">
<?php
if (version_compare(JVERSION, '1.6.0', 'ge')) {
	$query->clear() ->select('extension_id') ->from($db->quoteName('#__extensions')) ->where($db->quoteName('type') . ' = ' . $db->quote('module'))

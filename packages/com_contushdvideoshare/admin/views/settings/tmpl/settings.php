...
?>
	...
	<?php /** Logo Settings Fields Start Here */ ?>
	<div style="position: relative;">
		<fieldset class="adminform">
    ...
    ?>">
				<tr>
					<td class="key">
						<?php echo JHTML::tooltip('Enter Licence Key', '', '', 'Licence Key'); ?></td>
					<td><input type="text" name="licensekey" id="licensekey"
						style="float: left;" size="60" maxlength="200"
						value="<?php
...
<?php if (isset ( $player_values ['licensekey'] ) && $player_values ['licensekey'] == '') { ?> 
						...
						target="_blank"><img alt=""
							...
							width="77" height="23" style="margin: 3px 0 0 0;" /> </a> 
<?php  } ?>
					</td>
				</tr>
				<tr>
					<td class="key"><?php echo JHTML::tooltip('Allowed Extensions : jpg/jpeg, gif, png', '', '', 'Logo'); ?></td>
					<td>
						<div id="var_logo">
							<input name="logopath" id="logopath" maxlength="100"
								readonly="readonly"
								value="<?php if (isset ( $rs_editsettings [0]->logopath )) {
          echo $rs_editsettings [0]->logopath;
        }
        ?>"> <input type="button" name="change1" value="Change"
								maxlength="100" onclick="getFileUpload()">
						</div>
					</td>
<?php if (version_compare ( JVERSION, '3.0.0', 'ge' )) { ?>
					<td>&nbsp;</td> 
<?php } ?>
				...
				<tr>
					<td class="key">
						<?php echo JHTML::tooltip('Enter Logo Target URL', '', '', 'Logo Target URL'); ?></td>
					<td><input style="width: 150px;" type="text" name="logourl"
						value="<?php if (isset ( $player_values ['logourl'] )) {
...
<?php  } ?>
				...
				<tr>
					<td class="key">
						<?php echo JHTML::tooltip ( 'Edit the value to have transparency depth of logo', '', '', 'Logo Alpha' );
      ?></td>
					<td><input type="text" name="logoalpha"
						value="<?php if (isset ( $player_values ['logoalpha'] )) {
      ...
      ?>" /> %</td>
				...
				<tr>
					<td class="key">
						<?php echo JHTML::tooltip ( 'Select the Logo Position.Disabled in Demo Version.', '', '', 'Logo Position' );
      ?></td>
...
<?php if (isset ( $player_values ['logoalign'] ) && $player_values ['logoalign']) {

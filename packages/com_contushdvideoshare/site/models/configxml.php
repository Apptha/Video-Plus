...
class Modelcontushdvideoshareconfigxml extends ContushdvideoshareModel {
  ...
  public function configxml($settingsrows) {
    ...
    $googleanalyticsID = $IMAAds_path = $login_page_url = $player_colors = $downloadpath = $player_icons = $player_values = $license = $subTitleBgColor = $subTitleColor = '';
    ...
    echo '<config> <stagecolor>' . $stagecolor . '</stagecolor> <autoplay>' . $autoplay . '</autoplay> <buffer>' . $buffer . '</buffer> 
        ...
        <license>' . $license . '</license> <logopath>' . $logopath . '</logopath> <logoalpha>' . $logoalpha . '</logoalpha> 
